...
注：零氪用户四象限分类（零氪休闲党 Persuasable 70\%、Lost Cause 25\%；零氪流失党 Persuadable 30\%、Lost Cause 65\%；Sleeping Dog 统一5\%），付费用户全量推送无象限区分。状态触发：生命周期$<$3天跳过$>$30元，高氪跳过$<$30元，已购$\geq$128元跳过$<$68元。
